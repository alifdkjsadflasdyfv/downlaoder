...
function renderListVideo(vitems) {
    if (vitems.length) {
        ...
        for (i = 0; i < vitems.length; ++i) {
            ...
            var i_html = '<li> <a  href="' + c_url + '" title="' + item.t + '" target="_blank"> <img src="https://i.ytimg.com/vi/' + item.v + '/0.jpg" width="100%" height="100%"  alt="yt1s youtube downloader"/> <div class="content"><div class="clearfix"><h3>' + item.t + '</h3></div></div></a></li>';
...
function renderDetail(vData) {
    ...
    detail_html += '<span id="mesg-convert" class="form-control mesg-convert hidden"> <span class="lds-dual-ring"></span> ' + txt_processing + '</span>' +
        '<a id="asuccess" class="form-control mesg-convert success hidden" target="_blank" rel="nofollow" href="#"> ' + txt_download + ' </a> &nbsp &nbsp' +
...
function renderFacebook(vData) {
    ...
    if (vData.links != undefined && vData.links != null) {
        ...
        detail_html += '<a id="asuccess" class="form-control mesg-convert success" target="_blank" rel="nofollow" href="' + fq_selected + '" download="' + dl_title + '" data-type="mp4">' + txt_download + '</a>';
    }
...
function load_qc() {
    ...
    $.getScript("https://yt1s.com/statics/js/pn.js");
